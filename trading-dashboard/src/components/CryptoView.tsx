    ...
    <div className="space-y-4">
      <div>
        <h2 className={`text-xl font-bold ${isLight ? 'text-gray-900' : isSpace ? 'text-white drop-shadow-lg' : 'text-white'
          ...
          <Coins className={`w-5 h-5 ${isLight ? 'text-yellow-600' : isSpace ? 'text-yellow-400 drop-shadow' : 'text-yellow-400'
            }`} />
      ...
      <div className={`${isLight
        ...
        <div>
          <p className={`${isLight ? 'text-gray-700' : isSpace ? 'text-gray-300' : 'text-gray-300'
            ...
            <Zap className={`w-4 h-4 ${isLight ? 'text-yellow-600' : isSpace ? 'text-yellow-400 drop-shadow' : 'text-yellow-400'
              }`} />
      ...
      {loading && (
        <div className={`${isLight
          ...
          <Loader2 className={`w-12 h-12 ${isLight ? 'text-yellow-600 animate-spin' : 'text-yellow-400 animate-spin'
            } mx-auto mb-4`} />
          <p className={`${isLight ? 'text-gray-600' : isSpace ? 'text-gray-300' : 'text-gray-400'
      ...
      {!loading && predictions.length === 0 && !error && (
        <div className={`${isLight
          ...
          <Coins className={`w-16 h-16 ${isLight ? 'text-yellow-600 mx-auto mb-4 opacity-50' : 'text-yellow-400 mx-auto mb-4 opacity-50'
            }`} />
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`font-bold text-lg ${isLight ? 'text-gray-900' : isSpace ? 'text-white drop-shadow' : 'text-white'
                            }`}>{symbol}</span>
                        </div>

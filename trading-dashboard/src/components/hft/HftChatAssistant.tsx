...
import type { HftChatMessage } from '../../types/hft';
...
const CommandHelp = styled.div<{ $show: boolean }>`
  background: #f8f9fa;
  padding: 15px;
  border-radius: 8px;
  margin-bottom: 15px;
...
const MessageRole = styled.span<{ isUser: boolean }>`
...
interface HftChatAssistantProps {
    messages: HftChatMessage[];
    onSendMessage: (message: string) => Promise<void>;
}

const HftChatAssistant: React.FC<HftChatAssistantProps> = ({ messages, onSendMessage }) => {
...
export default HftChatAssistant;
